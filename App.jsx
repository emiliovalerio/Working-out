...
const cycle = {
  phases: [
      ...
      days: [
        {
          ...
          exercises: [
            { name: "Barbell Bench Press", sets: "3", reps: "8–10", note: "Controlled — no pause needed" },
            { name: "Lat Pulldown", sets: "3", reps: "10–12", note: "Full stretch each rep" },
            { name: "Incline Chest Press Machine", sets: "3", reps: "10–12", note: "" },
            { name: "Seated Cable Row", sets: "3", reps: "10–12", note: "Squeeze 1 sec at contraction" },
            { name: "Dumbbell Lateral Raise", sets: "3", reps: "12–15", note: "" },
            { name: "Cable Bar Curl", sets: "3", reps: "10–12", note: "" },
            { name: "Rope Pressdown", sets: "3", reps: "12–15", note: "Deep stretch at bottom" },
          ],
        ...
        },
        {
          ...
          exercises: [
            { name: "Hack Squat / Smith Squat", sets: "4", reps: "10–12", note: "Full depth, controlled" },
            { name: "Leg Press", sets: "3", reps: "12–15", note: "Feet shoulder-width" },
            { name: "Leg Extension", sets: "3", reps: "12–15", note: "2 sec squeeze at top" },
            { name: "Dumbbell Romanian Deadlift", sets: "3", reps: "10–12", note: "Stretch-focused" },
            { name: "Lying Hamstring Curl", sets: "3", reps: "12–15", note: "" },
            { name: "Standing Calf Raise", sets: "3", reps: "15–20", note: "3 sec stretch at bottom" },
        ...
        },
        {
          ...
          exercises: [
            ...
            { name: "Cross-Body Single-Arm Pressdown", sets: "2", reps: "12–15", note: "No dropset this phase" },
          ],
          rest: "60–90 sec between sets",
        },
        {
          ...
          exercises: [
            { name: "Chest-Supported T-Bar Row", sets: "4", reps: "10–12", note: "Full stop each rep" },
            { name: "Machine High Row", sets: "3", reps: "10–12", note: "" },
            { name: "Straight-Arm Pulldown", sets: "3", reps: "12–15", note: "Full lat stretch" },
            { name: "Pull-Ups (assisted)", sets: "3", reps: "8–10", note: "" },
    ...
    },
    {
      ...
      color: "#C0A060",
      accent: "#D4B878",
      description: "2 sets on primaries · 4–8 reps · load increases · return to technical failure",
      nutrition: "Return to moderate deficit · protein maintained · carbs around training",
      days: null,
      note: "Resume your standard UL/PPL Mentzer split — reduce sets back to 1–2, push load up, return to technical failure. This phase bridges volume weeks back into max intensity.",
    },
    {
      weeks: "5",
      label: "DELOAD",
      ...
      days: null,
      note: "Run your standard split but stop 2–3 reps short of failure on every exercise. Bar speed and joint feel are your metrics this week, not load.",
    },
    {
      weeks: "6",
      label: "FAST + REST",
      ...
      nutrition: "Fast Sun night → Wed night · break with protein-forward meal · Day 1 post-fast normal eating",
      days: null,
      note: "This is your full week off. The fast forces the rest. CNS, connective tissue, and hormonal systems all reset simultaneously. No cardio beyond easy walking.",
    },
    {
      weeks: "7–8",
      label: "SUPERCOMP",
      ...
      nutrition: "Slight caloric surplus · maximize carbs Day 1 + Day 2 · this is where recomp happens",
      days: null,
      note: "Back to full UL/PPL Mentzer split at max intensity. Glycogen refills, strength rebounds fast, physique tightens. Expect PRs here — supercompensation is real.",
    },
  ],
};
    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .scroll-x::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.1); border-radius: 2px; }
      `}</style>
      ...
      <div style={{ padding: "24px 24px 0" }}>
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ color: phase.color, fontSize: "12px" }}>🥩</span>
            <div style={{
              fontFamily: "'DM Sans', sans-serif",
              fontSize: "12px",
      ...
      {phase.days ? (
        <div style={{ padding: "0 24px 40px" }}>
          {/* Day Tabs */}
          <div className="scroll-x" style={{ display: "flex", gap: "6px", marginBottom: "16px", paddingBottom: "2px" }}>
            {phase.days.map((d, i) => (
              <button
                key={i}
                className="day-tab"
        ...
        <div style={{ padding: "0 24px 40px" }}>
          <div style={{
            ...
            {activePhase === 1
              ? "Resume your standard UL/PPL Mentzer split with 1–2 working sets, pushing load up and returning to technical failure across all 5 days."
              : activePhase === 2
              ? "Run all 5 days of your UL/PPL split — Upper · Lower · Push · Pull · Legs — stopping 2–3 reps short of failure every set. No PRs this week."
              : activePhase === 3
              ? "No gym. Walking only. Electrolytes 2–3× daily. Creatine 5g. Sleep is your training this week."
              : "Run all 5 days at full Mentzer intensity. Slight caloric surplus. Heavy carbs on Upper and Lower days. This is where the recomposition reward comes in."}
          </div>
        </div>
      )}
